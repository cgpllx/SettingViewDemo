...
public class BaseFragment extends Fragment {
	...
	protected View initView(DisplayOptions selectorPara) {
		...
		groupView3.addRowViewItem(ListRowView.class, 1, "同时下载线程数", R.drawable.qq6, R.drawable.arrow_to_right, ParaSetting.xiazshud7).setEntries("1个", "2个", "3个", "4个", "5个").setEntryValues(1, 2, 3, 4, 5);
